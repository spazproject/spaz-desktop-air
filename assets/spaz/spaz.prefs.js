...
Spaz.Prefs.setSoundFileLocations = function() {
	...
	soundFileUpdate = soundFileUpdate.resolvePath(Spaz.Const.userdirSound + 'update.mp3');
	if (soundFileUpdate.exists) {
		Spaz.Prefs.preferences[Spaz.Const.soundUpdate] = soundFileUpdate.url;
	}
	air.trace(Spaz.Const.soundUpdate + ' is: ' + Spaz.Prefs.preferences[Spaz.Const.soundUpdate]);

	var soundFileStartup = air.File.applicationStorageDirectory;
	soundFileStartup = soundFileStartup.resolvePath(Spaz.Const.userdirSound + 'startup.mp3');
	if (soundFileStartup.exists) {
		Spaz.Prefs.preferences[Spaz.Const.soundStartup] = soundFileStartup.url;
	}
	air.trace(Spaz.Const.soundStartup + ' is: ' + Spaz.Prefs.preferences[Spaz.Const.soundStartup]);

	var soundFileShutdown = air.File.applicationStorageDirectory;
	soundFileShutdown = soundFileShutdown.resolvePath(Spaz.Const.userdirSound + 'shutdown.mp3');
	if (soundFileShutdown.exists) {
		Spaz.Prefs.preferences[Spaz.Const.soundShutdown] = soundFileShutdown.url;
	}
	air.trace(Spaz.Const.soundShutdown + ' is: ' + Spaz.Prefs.preferences[Spaz.Const.soundShutdown]);

	var soundFileNew = air.File.applicationStorageDirectory;
	soundFileNew = soundFileNew.resolvePath(Spaz.Const.userdirSound + 'new.mp3');
	if (soundFileNew.exists) {
		Spaz.Prefs.preferences[Spaz.Const.soundNew] = soundFileNew.url;
	}
	air.trace(Spaz.Const.soundNew + ' is: ' + Spaz.Prefs.preferences[Spaz.Const.soundNew]);

	var soundFileWilhelm = air.File.applicationStorageDirectory;
	soundFileWilhelm = soundFileWilhelm.resolvePath(Spaz.Const.userdirSound + 'wilhelm.mp3');
	if (soundFileWilhelm.exists) {
		Spaz.Prefs.preferences[Spaz.Const.soundWilhelm] = soundFileWilhelm.url;
	}
	air.trace(Spaz.Const.soundWilhelm + ' is: ' + Spaz.Prefs.preferences[Spaz.Const.soundWilhelm]);
};
